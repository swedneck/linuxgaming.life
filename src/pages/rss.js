...
const RssPage = () => (
    <div>
        ...
        <p>
            <UserPill userId="@rss:linuxgaming.life" img="media.png" /> is a bot that posts new entries from RSS/atom feeds.</p>
        <h4>Adding the bot to your room</h4>
        <ol>
            <li>Invite <UserPill userId="@rss:linuxgaming.life" img="media.png" /> to your room</li>
